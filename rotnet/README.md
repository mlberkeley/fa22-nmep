...
### Project Objectives
In this project you will learn the following valuable skills as discussed in lecture/homework:
...
1. Read this paper by 10/11. https://arxiv.org/pdf/1803.07728.pdf
2. Load and generate the rotation dataset. Start learning how to implement pytorch DataLoaders.
3. Complete the model architecture (resnet18) and training loop. Date: 10/17
4. Debug model and complete training and show results. Date: 10/20
5. Completed project with results is due on October 21 at 11:59pm. Submit whatever you have at this stage because you **really** need to work on projects after this.

### Results
Please submit your code to Gradescope, along with a README.md/pdf/html file describing your implementation in detail. Please include training results (how many epochs, how low did your loss get, what was your accuracy on predicting rotations, etc.) in this file as well.

### Setting up your environment
You will need to figure out what dependencies to use and how to setup your environment. Please remember to use conda!! Quick guide:
```bash
conda create -n rotnet python=3.10
...
You may use any compute you want. You're encouraged to use the ML@B Server. Please refer to the guidelines in #compute. You may also use colab/notebooks, but make sure the notebook is not a monolith.
...
Once you have implemented the model, you can start training by running `main.py` with something like the following command:
